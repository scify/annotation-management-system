...
return [
    ...
    'use_floating_modal' => false, // Set to true to enable the use of showModal() on the dialog HTML element
    /*
    |--------------------------------------------------------------------------
    | Editor
    |--------------------------------------------------------------------------
    ...
    'cookies' => [
        'strictly_necessary' => [
            [
                ...
                'name' => 'scify_ams__cookies_consent',
