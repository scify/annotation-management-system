...
return [
    'only' => ['dashboard', 'users.index', 'users.create', 'users.store', 'users.show',
        ...
        'annotation.show', 'annotation.submit-pending', 'annotation.submit-annotation', 'annotation.flag-instance', 'annotation.send-to-manager', 'notifications.reply', 'notifications.approve', 'notifications.reject',
