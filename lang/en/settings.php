...
return [
    ...
    'annotator_password_policy' => [
        'title' => 'Annotator Password Policy',
        'description' => 'Configure the password rules applied when creating or updating annotator accounts.',
        'min_length' => 'Minimum length',
        'composition_mode' => 'Composition mode',
        'mixed_case_required' => 'Require mixed case (upper and lower)',
        'save_button' => 'Save policy',
        'saved' => 'Saved',
        'preview_title' => 'Current policy enforces:',
        'preview_min_length' => 'At least :n characters',
        'preview_mixed_case' => 'Mixed case required',
        'composition_modes' => [
            'no_restriction' => 'No restriction',
            'letters_only' => 'Letters only',
            'letters_and_numbers' => 'Letters and numbers',
            'letters_numbers_and_symbols' => 'Letters, numbers and symbols',
        ],
    ],
    'profile' => [
