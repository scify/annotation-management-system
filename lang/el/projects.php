...
return [
    ...
    'managers_tab' => [
        ...
        'invite_not_found_description' => 'Δεν βρέθηκε συνυπεύθυνος με το email :email. Μπορείτε να δημιουργήσετε τώρα τον χρήστη και να τον συνδέσετε με αυτό το έργο.',
        'invite_not_found_description_no_permission' => 'Δεν βρέθηκε συνυπεύθυνος με το email :email. Ζητήστε από έναν διαχειριστή να δημιουργήσει τον χρήστη και έπειτα προσκαλέστε τον.',
        'invite_create_user' => 'Δημιουργία συνυπεύθυνου',
        ...
        'transfer_cancelled' => 'Η μεταβίβαση ιδιοκτησίας ακυρώθηκε.',
        'ownership_accepted' => 'Είστε πλέον ο ιδιοκτήτης αυτού του έργου.',
        'ownership_rejected' => 'Η πρόταση ιδιοκτησίας απορρίφθηκε.',
        'leave_request_sent' => 'Το αίτημα αποχώρησης στάλθηκε.',
        'leave_request_cancelled' => 'Το αίτημα αποχώρησης αποσύρθηκε.',
        'leave_approved' => 'Το αίτημα αποχώρησης εγκρίθηκε.',
        'leave_rejected' => 'Το αίτημα αποχώρησης απορρίφθηκε.',
    ...
    'messages' => [
        ...
        'manager_removed' => 'Ο υπεύθυνος αφαιρέθηκε από το έργο.',
