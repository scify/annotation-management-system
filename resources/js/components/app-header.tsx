		...
		<>
			<div className="border-sidebar-border/80 border-b">
				<div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
					...
					{/* Desktop Navigation — plain styled nav links (no NavigationMenu) */}
					<nav
						...
						{navItems.map((item) => (
							...
							>
								<Link
									href={item.href as string}
									className={cn(
										'bg-background hover:bg-accent hover:text-accent-foreground inline-flex h-9 cursor-pointer items-center justify-center rounded-md px-3 text-sm font-medium transition-colors focus-visible:outline-none',
										page.url === item.href &&
