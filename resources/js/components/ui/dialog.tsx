...
function DialogContent({
    ...
    return (
        ...
        >
            <Modal
                className={cn(
                    'bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-1rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200',
                        ...
                        <DialogContext.Provider value={ctx}>
                            <div data-slot="dialog-content" {...props}>
                                ...
                                <button
                                    ...
                                    className="ring-offset-background focus:ring-ring absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 hover:cursor-pointer"
                                >
                                    <XIcon />
...
function DialogDescription({ className, ...props }: Readonly<React.ComponentProps<'div'>>) {
    return (
        <div
